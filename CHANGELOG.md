...
* Added a lightweight classic football SVG in a dedicated public-header animation lane, with responsive sizing, tab-hidden pausing, safe non-interactive layering, and a static reduced-motion presentation.
